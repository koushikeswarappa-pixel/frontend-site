/*! sprintf-js v1.1.1 | Copyright (c) 2007-present, Alexandru Mărășteanu <hello@alexei.ro> | BSD-3-Clause */ ! function() {
    "use strict";
...
(function() {
    ...
    */
    ...
    k("lp_intlTelInputUtils.formatNumber", function(a, b, c) {
        try {
            var d = K.g(),
                e = Z(d, a, b),
                g = Oa(d, e);
    ...
    k("lp_intlTelInputUtils.getExampleNumber", function(a, b, c) {
        try {
            var d = K.g();
            a: {
                if (Q(a)) {
    ...
    k("lp_intlTelInputUtils.getExtension", function(a, b) {
        try {
    ...
    k("lp_intlTelInputUtils.getNumberType", function(a, b) {
        try {
            var c = K.g();
            var d = Z(c, a, b),
                e = Na(c, d),
    ...
    k("lp_intlTelInputUtils.getValidationError", function(a, b) {
        try {
            var c = K.g(),
                d = Z(c, a, b);
            return Oa(c, d)
    ...
    k("lp_intlTelInputUtils.isValidNumber", function(a, b) {
        try {
            var c = K.g(),
                d = Z(c, a, b);
            var e = Na(c, d),
    ...
    k("lp_intlTelInputUtils.numberFormat", {
        E164: 0,
        INTERNATIONAL: 1,
        NATIONAL: 2,
        RFC3966: 3
    });
    k("lp_intlTelInputUtils.numberType", {
        FIXED_LINE: 0,
        MOBILE: 1,
    ...
    k("lp_intlTelInputUtils.validationError", {
        IS_POSSIBLE: 0,
...
! function(a) {
    "object" == typeof module && module.exports ? module.exports = a() : window.lp_intlTelInput = a()
}(function(a) {
    "use strict";
    return function() {
        function b(a, b) {
        ...
        var h = {
            getInstance: function(a) {
                ...
                return window.lp_intlTelInputGlobals.instances[b]
            },
            instances: {},
        ...
        "object" == typeof window && (window.lp_intlTelInputGlobals = h);
        var i = 0,
            j = {
                allowDropdown: !0,
                autoHideDialCode: !0,
            ...
            m = function(a) {
                l(window.lp_intlTelInputGlobals.instances, function(b) {
                    window.lp_intlTelInputGlobals.instances[b][a]()
                })
            },
            n = function() {
                function c(a, d) {
                ...
                return d(c, [{
                    ...
                    value: function() {
                        ...
                        var a = "lp_iti";
                        this.d.allowDropdown && (a += " lp_iti--allow-dropdown"), this.d.separateDialCode && (a += " lp_iti--separate-dial-code"), this.d.customContainer && (a += " ", a += this.d.customContainer);
                        var b = this._e2("div", {
                            "class": a
                        });
                        if (this.a.parentNode.insertBefore(b, this.a), this.k = this._e2("div", {
                                "class": "lp_iti__flag-container"
                            }, b), b.appendChild(this.a), this.selectedFlag = this._e2("div", {
                                "class": "lp_iti__selected-flag",
                                role: "combobox",
                                "aria-controls": "lp_iti-".concat(this.id, "__country-listbox"),
                                "aria-owns": "lp_iti-".concat(this.id, "__country-listbox"),
                                "aria-expanded": "false"
                            }, this.k), this.l = this._e2("div", {
                                "class": "lp_iti__flag"
                            }, this.selectedFlag), this.d.separateDialCode && (this.t = this._e2("div", {
                                "class": "lp_iti__selected-dial-code"
                            }, this.selectedFlag)), this.d.allowDropdown && (this.selectedFlag.setAttribute("tabindex", "0"), this.u = this._e2("div", {
                                "class": "lp_iti__arrow"
                            }, this.selectedFlag), this.m = this._e2("ul", {
                                "class": "lp_iti__country-list lp_iti__hide",
                                id: "lp_iti-".concat(this.id, "__country-listbox"),
                                role: "listbox",
                                "aria-label": "List of countries"
                            }), this.preferredCountries.length && (this._g(this.preferredCountries, "lp_iti__preferred", !0), this._e2("li", {
                                "class": "lp_iti__divider",
                                role: "separator",
                                "aria-disabled": "true"
                            }, this.m)), this._g(this.p, "lp_iti__standard"), this.d.dropdownContainer ? (this.dropdown = this._e2("div", {
                                "class": "lp_iti lp_iti--container"
                    ...
                    value: function() {
                        var a = this;
                        this._a9 = function(b) {
                            a.m.classList.contains("lp_iti__hide") ? a.a.focus() : b.preventDefault()
                        };
                        var b = this._i1();
                        b && b.addEventListener("click", this._a9), this._a10 = function() {
                            !a.m.classList.contains("lp_iti__hide") || a.a.disabled || a.a.readOnly || a._n()
                        }, this.selectedFlag.addEventListener("click", this._a10), this._a11 = function(b) {
                            a.m.classList.contains("lp_iti__hide") && -1 !== ["ArrowUp", "Up", "ArrowDown", "Down", " ", "Enter"].indexOf(b.key) && (b.preventDefault(), b.stopPropagation(), a._n()), "Tab" === b.key && a._2()
                    ...
                    value: function() {
                        var a = this;
                        this.d.utilsScript && !window.lp_intlTelInputUtils ? window.lp_intlTelInputGlobals.documentReady() ? window.lp_intlTelInputGlobals.loadUtils(this.d.utilsScript) : window.addEventListener("load", function() {
                            window.lp_intlTelInputGlobals.loadUtils(a.d.utilsScript)
                        }) : this.i0(), "auto" === this.d.initialCountry ? this._i4() : this.h()
                    }
                }, {
                    key: "_i4",
                    value: function() {
                        window.lp_intlTelInputGlobals.autoCountry ? this.handleAutoCountry() : window.lp_intlTelInputGlobals.startedLoadingAutoCountry || (window.lp_intlTelInputGlobals.startedLoadingAutoCountry = !0, "function" == typeof this.d.geoIpLookup && this.d.geoIpLookup(function(a) {
                            window.lp_intlTelInputGlobals.autoCountry = a.toLowerCase(), setTimeout(function() {
                    ...
                    key: "_n",
                    value: function() {
                        this.m.classList.remove("lp_iti__hide"), this.selectedFlag.setAttribute("aria-expanded", "true"), this._o(), this.b && (this._x(this.b, !1), this._3(this.b, !0)), this._p(), this.u.classList.add("lp_iti__arrow--up"), this._m2("open:countrydropdown")
                    }
                }, {
                    key: "_n2",
                    value: function(a, b, c) {
                    ...
                    value: function() {
                        ...
                        if (this.d.dropdownContainer && this.d.dropdownContainer.appendChild(this.dropdown), !this.g) {
                            var b = this.a.getBoundingClientRect(),
                                ...
                                g = d - e > c;
                            if (this._n2(this.m, "lp_iti__country-list--dropup", !f && g), this.d.dropdownContainer) {
                    ...
                    key: "_o2",
                    value: function(a) {
                        for (var b = a; b && b !== this.m && !b.classList.contains("lp_iti__country");) b = b.parentNode;
                    ...
                    value: function(a) {
                        ...
                        b && (b.classList.contains("lp_iti__divider") && (b = "ArrowUp" === a || "Up" === a ? b.previousElementSibling : b.nextElementSibling), this._x(b, !0))
                    }
                }, {
                    key: "_r",
                    value: function() {
                    ...
                    value: function(a) {
                        for (var b = 0; b < this.p.length; b++)
                            if (this._t(this.p[b].name, a)) {
                                var c = this.m.querySelector("#lp_iti-".concat(this.id, "__item-").concat(this.p[b].iso2));
                    ...
                    value: function(a) {
                        var b = a;
                        if (this.d.formatOnDisplay && window.lp_intlTelInputUtils && this.s) {
                            var c = !this.d.separateDialCode && (this.d.nationalMode || "+" !== b.charAt(0)),
                                d = lp_intlTelInputUtils.numberFormat,
                                e = d.NATIONAL,
                                f = d.INTERNATIONAL,
                                g = c ? e : f;
                            b = lp_intlTelInputUtils.formatNumber(b, this.s.iso2, g)
                        }
                    ...
                    value: function(a, b) {
                        var c = this.c;
                        c && c.classList.remove("lp_iti__highlight"), this.c = a, this.c.classList.add("lp_iti__highlight"), b && this.c.focus()
                    }
                }, {
                    key: "_y",
                    value: function(a, b, c) {
                    ...
                    value: function(a) {
                        ...
                        this.s = a ? this._y(a, !1, !1) : {}, this.s.iso2 && (this.j = this.s.iso2), this.l.setAttribute("class", "lp_iti__flag lp_iti__".concat(a));
                        ...
                        if (this._0(), this.d.allowDropdown) {
                            var f = this.b;
                            if (f && (f.classList.remove("lp_iti__active"), f.setAttribute("aria-selected", "false")), a) {
                                var g = this.m.querySelector("#lp_iti-".concat(this.id, "__item-").concat(a, "-preferred")) || this.m.querySelector("#lp_iti-".concat(this.id, "__item-").concat(a));
                                g.setAttribute("aria-selected", "true"), g.classList.add("lp_iti__active"), this.b = g, this.selectedFlag.setAttribute("aria-activedescendant", g.getAttribute("id"))
                            }
                        }
                        return b.iso2 !== a
                    }
                    ...
                    value: function() {
                        ...
                        if (window.lp_intlTelInputUtils && a) {
                            var b = lp_intlTelInputUtils.numberType[this.d.placeholderNumberType],
                                c = this.s.iso2 ? lp_intlTelInputUtils.getExampleNumber(this.s.iso2, this.d.nationalMode, b) : "";
                    ...
                    value: function() {
                        "auto" === this.d.initialCountry && (this.j = window.lp_intlTelInputGlobals.autoCountry, this.a.value || this.setCountry(this.j), this.h())
                    }
                }, {
                    key: "handleUtils",
                    value: function() {
                        window.lp_intlTelInputUtils && (this.a.value && this._u(this.a.value), this._0()), this.i0()
                    }
                }, {
                    key: "destroy",
                    value: function() {
                        ...
                        c.parentNode.insertBefore(this.a, c), c.parentNode.removeChild(c), delete window.lp_intlTelInputGlobals.instances[this.id]
                    }
                }, {
                    key: "getExtension",
                    value: function() {
                        return window.lp_intlTelInputUtils ? lp_intlTelInputUtils.getExtension(this._6(), this.s.iso2) : ""
                    }
                }, {
                    key: "getNumber",
                    value: function(a) {
                        if (window.lp_intlTelInputUtils) {
                            var b = this.s.iso2;
                            return lp_intlTelInputUtils.formatNumber(this._6(), b, a)
                        }
                        return ""
                    }
                }, {
                    key: "getNumberType",
                    value: function() {
                        return window.lp_intlTelInputUtils ? lp_intlTelInputUtils.getNumberType(this._6(), this.s.iso2) : -99
                    }
                }, {
                    ...
                    value: function() {
                        if (window.lp_intlTelInputUtils) {
                            var a = this.s.iso2;
                            return lp_intlTelInputUtils.getValidationError(this._6(), a)
                        }
                        return -99
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        return window.lp_intlTelInputUtils ? lp_intlTelInputUtils.isValidNumber(a, b) : null
                    }
                }, {
                    key: "setCountry",
                    value: function(a) {
                        var b = a.toLowerCase();
                        this.l.classList.contains("lp_iti__".concat(b)) || (this._z(b), this._4(this.s.dialCode, !1), this._m2CountryChange())
                    }
                }, {
                    key: "setNumber",
                    value: function(a) {
        ...
        var o = function(a, b, c) {
            ...
            }, d.className = "lp_iti-load-utils", d.async = !0, d.src = a, document.body.appendChild(d)
        };
        return h.loadUtils = function(a) {
                if (!window.lp_intlTelInputUtils && !window.lp_intlTelInputGlobals.startedLoadingUtilsScript) {
                    if (window.lp_intlTelInputGlobals.startedLoadingUtilsScript = !0, "undefined" != typeof Promise) return new Promise(function(b, c) {
                        return o(a, b, c)
                    });
                    o(a)
                }
                return null
            }, h.defaults = j, h.version = "17.0.19",
            function(a, b) {
                var c = new n(a, b);
                return c._init(), a.setAttribute("data-intl-tel-input-id", c.id), window.lp_intlTelInputGlobals.instances[c.id] = c, c
            }
    }()
});
